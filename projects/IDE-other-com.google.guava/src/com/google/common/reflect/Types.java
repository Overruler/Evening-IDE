...
final class Types {
  ...
  private static final class TypeVariableImpl<D extends GenericDeclaration>
    ...
    public @Override <T extends Annotation> T getAnnotation(Class<T> annotationClass) {
      return null;
    }
    ...
    public @Override Annotation[] getDeclaredAnnotations() {
      return new Annotation[0];
    }

    public @Override AnnotatedType[] getAnnotatedBounds() {
